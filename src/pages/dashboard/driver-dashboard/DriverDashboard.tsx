            ...
            <nav className="flex-1 px-2 py-4 bg-gray-800">
              ...
              <div className="mb-2 relative group">
                ...
                <label
                  ...
                  className="flex items-center px-12 py-2 mt-2 text-gray-100 hover:bg-gray-700 cursor-pointer w-full"
                >
                  Messages
                </label>

                <div className="absolute left-4 top-2 transform #dis-translate-y-1/2 flex items-center text-white">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4 ml-auto transition-transform transform peer-checked:rotate-180 absolute right-4 top-3 transform #dis--translate-y-1/2 text-white"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
