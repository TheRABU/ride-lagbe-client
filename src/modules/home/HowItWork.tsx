      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="max-w-2xl mx-auto mt-4 text-base text-gray-400 leading-relaxed md:text-2xl">
            Our platform will help you find rides for your desired destination
          </p>
        </div>
          ...
          <div className="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12">
            <div>
              ...
              <p className="mt-4 text-base text-gray-400 md:text-lg">
                Select where you want to go and your position
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-4 text-base text-gray-400 md:text-lg">
                Put in your personalized details and let our platform find the
                nearest driver
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-4 text-base text-gray-400 md:text-lg">
                Once you've reached pay your fare. Simple
              </p>
            </div>
          </div>
        </div>
