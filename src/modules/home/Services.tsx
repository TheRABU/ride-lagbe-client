    ...
    <div className="bg-black">
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
          {/* 1️⃣ Customizable */}
          <div className="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow hover:bg-neutral-800 transition duration-300">
            <div
              className="button-text mx-auto flex h-12 w-12 items-center justify-center rounded-md border"
              style={{
                backgroundImage:
                  "linear-gradient(180deg, rgb(80, 70, 229) 0%, rgb(43, 49, 203) 100%)",
                borderColor: "rgb(93, 79, 240)",
              }}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="icon icon-tabler icon-tabler-color-swatch text-white"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                strokeWidth="2"
          ...
          <div className="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow hover:bg-neutral-800 transition duration-300">
            ...
            <p className="my-4 mb-0 text-gray-400">
              We build our templates with speed in mind for super-fast load
          ...
          <div className="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow hover:bg-neutral-800 transition duration-300">
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="icon icon-tabler icon-tabler-tools text-white"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                strokeWidth="2"
